...
while True:
    ...
    person_counter = 0  # Reset person counter
    ...
    # Display the resulting frame with person counter
    cv2.putText(frame, f"Number of people: {person_counter}", (10, 50), font, 2, (0, 0, 255), 2)
